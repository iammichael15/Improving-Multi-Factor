...
ALTER TABLE keystroke_data 
  DROP CONSTRAINT keystroke_data_user_id_fkey,
  ALTER COLUMN user_id TYPE text,
  RENAME COLUMN user_id TO session_id;

-- Modify mouse_data table
ALTER TABLE mouse_data 
  DROP CONSTRAINT mouse_data_user_id_fkey,
  ALTER COLUMN user_id TYPE text,
  RENAME COLUMN user_id TO session_id;

-- Modify task_completions table
ALTER TABLE task_completions 
  DROP CONSTRAINT task_completions_user_id_fkey,
  ALTER COLUMN user_id TYPE text,
  RENAME COLUMN user_id TO session_id;
